...
private:
	...
	cntr_t __extra_cache_miss_cntr;
	cntr_t __extra_cache_hit_cntr;
...
public:
	...
	void inc_extra_cache_hit_cntr();
	void inc_extra_cache_miss_cntr();
	...
	void inc_mem_write_cycle_cntr();
	void clear_mem_write_cycle_cntr();
