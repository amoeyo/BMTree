...
public:
	...
	AlignedRegionIdxTable back_index_table();
	AlignedRegionIdxTable fore_index_table();
	AlignedRegionIdxTable fore_state_table();
	uint32_t tick_clock();
	uint32_t valid_leaf_N();
...
private:
	AlignedRegionIdxTable __back_index_table;
	AlignedRegionIdxTable __fore_index_table;
	AlignedRegionIdxTable __fore_state_table;
	uint32_t __tick;
